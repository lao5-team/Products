        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < pictureList.size(); i++) {
                    //进行压缩和旋转
                    String localPath = Utility.processImage(pictureList.get(i).localPath,
                            Constants.MAX_PICTURE_WIDTH, Constants.MAX_PICTURE_HEIGHT, pictureList.get(i).rotArc, false);
